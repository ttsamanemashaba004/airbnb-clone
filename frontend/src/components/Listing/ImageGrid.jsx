  ...
  return (
    <div className="listing_page">
        <div className="listing_header">
          ...
          <p className="listing_header_details">
        ...
        <div className="listing_image_grid">
          ...
          <div className="image_rows">
            <div className="row_one">
              <img src={hotelData.image?.[1] || hotelData.image?.[0]} alt="" className="_image_one" />
              <img src={hotelData.image?.[2] || hotelData.image?.[0]} alt="" className="_image_one two" />
            </div>
            <div className="row_two">
              <img src={hotelData.image?.[3] || hotelData.image?.[0]}  alt="" className="_image_two" />
              <img src={hotelData.image?.[4] || hotelData.image?.[0]}  alt="" className="_image_two four" />
            </div>
          </div>
        </div>
      </div>
